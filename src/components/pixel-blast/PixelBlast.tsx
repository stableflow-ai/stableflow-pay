  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      if (oglRef.current) {
        ...
        t.pointerRoot?.removeEventListener("pointerdown", t.onPointerDown);
        t.renderer.gl.canvas.removeEventListener("pointermove", t.onPointerMove);
      ...
      const pointerRoot = container.closest("aside") ?? container;
