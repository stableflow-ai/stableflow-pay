...
export const PAYMENT_LINKS_TABLE_COLUMNS =
  "minmax(200px, 1.7fr) minmax(140px, 1fr) minmax(140px, 1fr) minmax(120px, 0.85fr) minmax(120px, 0.85fr) minmax(100px, 0.71fr) minmax(100px, 0.71fr) 50px 30px 30px 30px";
