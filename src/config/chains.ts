/**
 * Chain registry for Stableflow Pay.
 * Runtime lists come from GET /v1/pay/config; this file keeps UI metadata and
...
export const FIXED_CHAINS: ChainConfig[] = [
  { blockchain: "eth", chainName: "Ethereum", chainKind: "evm", chainId: 1, logo: chainLogoUrl("eth"), safeShortName: "eth", txExplorer: "https://etherscan.io/tx/" },
  { blockchain: "base", chainName: "Base", chainKind: "evm", chainId: 8453, logo: chainLogoUrl("base"), safeShortName: "base", txExplorer: "https://basescan.org/tx/" },
  { blockchain: "arb", chainName: "Arbitrum", chainKind: "evm", chainId: 42161, logo: chainLogoUrl("arb"), safeShortName: "arb1", txExplorer: "https://arbiscan.io/tx/" },
  { blockchain: "op", chainName: "Optimism", chainKind: "evm", chainId: 10, logo: chainLogoUrl("op"), safeShortName: "oeth", txExplorer: "https://optimistic.etherscan.io/tx/" },
  { blockchain: "pol", chainName: "Polygon", chainKind: "evm", chainId: 137, logo: chainLogoUrl("pol"), safeShortName: "matic", txExplorer: "https://polygonscan.com/tx/" },
  { blockchain: "bsc", chainName: "BNB Chain", chainKind: "evm", chainId: 56, logo: chainLogoUrl("bsc"), safeShortName: "bnb", txExplorer: "https://bscscan.com/tx/" },
  { blockchain: "avax", chainName: "Avalanche", chainKind: "evm", chainId: 43114, logo: chainLogoUrl("avax"), safeShortName: "avax", txExplorer: "https://snowscan.xyz/tx/" },
  { blockchain: "gnosis", chainName: "Gnosis", chainKind: "evm", chainId: 100, logo: chainLogoUrl("gnosis"), safeShortName: "gno", txExplorer: "https://gnosisscan.io/tx/" },
  { blockchain: "scroll", chainName: "Scroll", chainKind: "evm", chainId: 534352, logo: chainLogoUrl("scroll"), safeShortName: "scr", txExplorer: "https://scrollscan.com/tx/" },
  { blockchain: "xlayer", chainName: "X Layer", chainKind: "evm", chainId: 196, logo: chainLogoUrl("xlayer"), txExplorer: "https://www.okx.com/web3/explorer/xlayer/tx/" },
  { blockchain: "bera", chainName: "Berachain", chainKind: "evm", chainId: 80094, logo: chainLogoUrl("bera"), txExplorer: "https://berascan.com/tx/" },
  { blockchain: "near", chainName: "Near", chainKind: "near", logo: chainLogoUrl("near"), txExplorer: "https://nearblocks.io/txns/" },
  { blockchain: "sol", chainName: "Solana", chainKind: "solana", logo: chainLogoUrl("sol"), txExplorer: "https://solscan.io/tx/" },
  { blockchain: "tron", chainName: "Tron", chainKind: "tron", logo: chainLogoUrl("tron"), txExplorer: "https://tronscan.org/#/transaction/" },
  { blockchain: "zec", chainName: "Zcash", chainKind: "zec", logo: chainLogoUrl("zec"), txExplorer: "https://explorer.zcha.in/transactions/" },
];
...
export const FIXED_CHAIN_KINDS = new Map<ChainKind, ChainKindOption>();
