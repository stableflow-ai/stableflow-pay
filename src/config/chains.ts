...
export const FIXED_CHAINS: ChainConfig[] = [
  ...
  { blockchain: "zec", chainName: "Zcash", chainKind: "zec", logo: chainLogoUrl("zec"), payerEnabled: true, batchEnabled: false, txExplorer: "https://explorer.zcha.in/transactions/" },
];
