...
| `src/api/partner.ts` | API keys, reports analytics and payments |
...
| `src/hooks/use-partner-api.ts` | API keys query and key mutations |
...
| `src/types/partner.ts` | API key, reports analytics and payments types |
